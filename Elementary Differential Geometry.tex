...
% 1.6
\par
Let $V$ be the vector space ${\R}^{3}$ and denote the space of all $k$-linear forms on $V$ by ${\LA}^{k}({V}^{*})$. Every element of ${\LA}^{k}$


We define the wedge product to be the function $\wedge:{\LA}^{a}({V}^{*})\times{\LA}^{b}({V}^{*})$ such that 
